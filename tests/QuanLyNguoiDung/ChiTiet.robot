...
xoa sau khi dung xong
    ...
    Click Button    //td[text()='tao_de_xem_chi_tiet@gmail.com']/following-sibling::td[@class='actions']/button[text()='Xóa']
    Sleep    1s
    Handle Alert    ACCEPT
    Close All Browsers
...
tao user dummy de kiem tra chi tiet
    ...
    Click Element    //button[@form='personForm']
    Go To    http://localhost/person/list/
...
case001
    ...
    Run Keyword If    '${Email}'!='tao_de_xem_chi_tiet@gmail.com'    Fail    Sai giá trị trường Email
    ...
    Run Keyword If    '${Học vị}'!= 'Thạc sĩ'    Fail    Sai giá trị trường Học vị 
    
    ${Học thuật}    Get Text    //label[text()='Học thuật']/following-sibling::span
    Run Keyword If    '${Học thuật}'!= 'Giáo Sư'    Fail    Sai giá trị trường Học vị
